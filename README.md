# Algoritmo first and follow
## Hecho por Noah Esteban Narvéz

### Para utilizar el algoritmo es necesario situarse en el archivo FAF.py y darle click a compilar
### En el caso de que no se tenga la extensión de python en visual studio code es tan simple como usar
